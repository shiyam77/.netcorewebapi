    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EndpointPermissionID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EndpointId = table.Column<int>(nullable: false),
                    ...
                    MenuComponentsComponentID = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EndpointPermission", x => x.EndpointPermissionID);
                    table.ForeignKey(
                        name: "FK_EndpointPermission_MenuComponents_MenuComponentsComponentID",
                        column: x => x.MenuComponentsComponentID,
                        principalTable: "MenuComponents",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EndpointPermission_MenuComponentsComponentID",
                table: "EndpointPermission",
                column: "MenuComponentsComponentID");
        }
